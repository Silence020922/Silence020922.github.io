...
<span class="line"><span>}</span></span></code></pre></div><h3 id="k折交叉验证" tabindex="-1">k折交叉验证 <a class="header-anchor" href="#k折交叉验证" aria-label="Permalink to &quot;k折交叉验证&quot;">​</a></h3><p>bootstrap包中的crossval()函数可以实现k重交叉验证。 $R^2$的K折交叉验证函数</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>shrinkage &lt;- function(fit, k=10){</span></span>
...
<span class="line"><span>cat(result)}</span></span></code></pre></div>`,344),l=[e];function i(o,c,r,d,h,u){return s(),n("div",null,l)}const m=a(t,[["render",i]]);export{g as __pageData,m as default};
